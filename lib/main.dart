...
Future<void> main() async {
  ...
  if (Platform.isWindows) {
    setWindowTitle('Mycelium Wallet : Manager Product');
    setWindowMaxSize(const Size(1920, 1080));
    setWindowMinSize(const Size(1280, 926));
  } else if (Platform.isLinux) {
    setWindowTitle('Mycelium Wallet');
    setWindowMaxSize(const Size(1920, 1080));
  ...
  await Hive.openBox<User>('user_mycelium_wallet');
  await Hive.openBox<Settings>('settings_mycelium_wallet');
