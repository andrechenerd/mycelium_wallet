...
import 'package:mycelium_wallet_desktop/features/auth/presentation/pincode/domain/error_enum.dart';
        ...
        Padding(
          ...
          child: PinCodeTextField(
            ...
            pinTheme: PinTheme(
              ...
              inactiveColor: AppData.colors.mainGreenColor.withOpacity(0.2),
              activeColor: isPinCodeSuccess == ErrorPinCode.isSuccess
                  ? Colors.green
                  : AppData.colors.mainGreenColor,
              selectedFillColor: AppData.colors.mainGreenColor.withOpacity(0.1),
